...
interface ImageToImageSettingsProps {
  params: ImageToImageParams;
  onParamsChange: (updates: Partial<ImageToImageParams>) => void;
}

export function ImageToImageSettings({
  params,
  onParamsChange,
}: ImageToImageSettingsProps) {
